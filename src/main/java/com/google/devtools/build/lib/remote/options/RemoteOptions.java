...
public final class RemoteOptions extends OptionsBase {
  ...
  @Option(
      ...
      help = "If set to 'none' doesn't download any remote build outputs to the local machine. "
      + "This option can significantly reduce build times if network bandwidth is a bottleneck."
  )
